...
public class Calculadora_swing extends javax.swing.JFrame {
	...
	/**
	 * Creates new form Calculadora_swing
	 */
    ...
    private void initComponents() {
        ...
        panel_resultado = new javax.swing.JTextField();
        btn_punto = new javax.swing.JButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        btn_8.setText("8");
        btn_8.setMaximumSize(new java.awt.Dimension(30, 30));
        btn_8.setMinimumSize(new java.awt.Dimension(30, 30));
        ...
        btn_9.setText("9");
        btn_9.setMaximumSize(new java.awt.Dimension(30, 30));
        btn_9.setMinimumSize(new java.awt.Dimension(30, 30));
        ...
        btn_4.setText("4");
        btn_4.setMaximumSize(new java.awt.Dimension(30, 30));
        btn_4.setMinimumSize(new java.awt.Dimension(30, 30));
        ...
        btn_5.setText("5");
        btn_5.setMaximumSize(new java.awt.Dimension(30, 30));
        btn_5.setMinimumSize(new java.awt.Dimension(30, 30));
        ...
        btn_6.setText("6");
        btn_6.setMaximumSize(new java.awt.Dimension(30, 30));
        btn_6.setMinimumSize(new java.awt.Dimension(30, 30));
        ...
        btn_1.setText("1");
        btn_1.setMaximumSize(new java.awt.Dimension(30, 30));
        btn_1.setMinimumSize(new java.awt.Dimension(30, 30));
        ...
        btn_2.setText("2");
        btn_2.setMaximumSize(new java.awt.Dimension(30, 30));
        btn_2.setMinimumSize(new java.awt.Dimension(30, 30));
        ...
        btn_3.setText("3");
        btn_3.setMaximumSize(new java.awt.Dimension(30, 30));
        btn_3.setMinimumSize(new java.awt.Dimension(30, 30));
        ...
        btn_0.setText("0");
        btn_0.setMaximumSize(new java.awt.Dimension(30, 30));
        btn_0.setMinimumSize(new java.awt.Dimension(30, 30));
        ...
        btn_mas.setText("+");
        btn_mas.setMaximumSize(new java.awt.Dimension(30, 30));
        btn_mas.setMinimumSize(new java.awt.Dimension(30, 30));
        ...
        btn_menos.setText("-");
        btn_menos.setMaximumSize(new java.awt.Dimension(30, 30));
        btn_menos.setMinimumSize(new java.awt.Dimension(30, 30));
        ...
        btn_multiplicacion.setMaximumSize(new java.awt.Dimension(30, 30));
        btn_multiplicacion.setMinimumSize(new java.awt.Dimension(30, 30));
        ...
        btn_igual.setText("=");
        btn_igual.setPreferredSize(new java.awt.Dimension(25, 25));
        ...
        btn_clean.setText("CE");
        btn_clean.setMaximumSize(new java.awt.Dimension(35, 35));
        btn_clean.setMinimumSize(new java.awt.Dimension(35, 35));
        btn_clean.setPreferredSize(new java.awt.Dimension(50, 50));
        ...
        btn_7.setText("7");
        btn_7.setMaximumSize(new java.awt.Dimension(30, 30));
        btn_7.setMinimumSize(new java.awt.Dimension(30, 30));
        ...
        panel_resultado.setEditable(false);
        panel_resultado.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        panel_resultado.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(panel_resultado, javax.swing.GroupLayout.PREFERRED_SIZE, 254, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(24, 24, 24)
                .addComponent(panel_resultado, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void btn_8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_8ActionPerformed
		// TODO add your handling code here:
		panel_resultado.setText(panel_resultado.getText() + "8");
    }//GEN-LAST:event_btn_8ActionPerformed

    private void btn_9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_9ActionPerformed
		// TODO add your handling code here:
		panel_resultado.setText(panel_resultado.getText() + "9");
    }//GEN-LAST:event_btn_9ActionPerformed

    private void btn_4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_4ActionPerformed
		// TODO add your handling code here:
		panel_resultado.setText(panel_resultado.getText() + "4");
    }//GEN-LAST:event_btn_4ActionPerformed

    private void btn_5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_5ActionPerformed
		// TODO add your handling code here:
		panel_resultado.setText(panel_resultado.getText() + "5");
    }//GEN-LAST:event_btn_5ActionPerformed

    private void btn_6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_6ActionPerformed
		// TODO add your handling code here:
		panel_resultado.setText(panel_resultado.getText() + "6");
    }//GEN-LAST:event_btn_6ActionPerformed

    private void btn_1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_1ActionPerformed
		// TODO add your handling code here:
		panel_resultado.setText(panel_resultado.getText() + "1");
    }//GEN-LAST:event_btn_1ActionPerformed

    private void btn_2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_2ActionPerformed
		// TODO add your handling code here:
		panel_resultado.setText(panel_resultado.getText() + "2");
    }//GEN-LAST:event_btn_2ActionPerformed

    private void btn_3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_3ActionPerformed
		// TODO add your handling code here:
		panel_resultado.setText(panel_resultado.getText() + "3");
    }//GEN-LAST:event_btn_3ActionPerformed

    private void btn_0ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_0ActionPerformed
		// TODO add your handling code here:
		panel_resultado.setText(panel_resultado.getText() + "0");
    }//GEN-LAST:event_btn_0ActionPerformed

    private void btn_igualActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_igualActionPerformed
		// TODO add your handling code here:
		String resulta;
		num2 = panel_resultado.getText();
		if (!num2.equals("")) {
			resulta = calculadora(num1, num2, signo);
			panel_resultado.setText(resulta);
		}
    ...
    private void btn_puntoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_puntoActionPerformed
		// TODO add your handling code here:
		String texto = panel_resultado.getText();

		if (texto.length() <= 0) {
			//No existe nada en el panel
			panel_resultado.setText("0.");
		} else {
			if (!validarPunto(panel_resultado.getText())) {
				panel_resultado.setText(panel_resultado.getText() + ".");
			}
		}
    }//GEN-LAST:event_btn_puntoActionPerformed

	private static String calculadora (String num1, String num2, String signo){
    ...
    private javax.swing.JTextField panel_resultado;
